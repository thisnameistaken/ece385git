...
module lab7_soc_mm_interconnect_0 (
	...
	wire   [28:0] switch_s1_agent_m0_address;                                                         // switch_s1_agent:m0_address -> switch_s1_translator:uav_address
	...
	wire  [107:0] switch_s1_agent_rf_source_data;                                                     // switch_s1_agent:rf_source_data -> switch_s1_agent_rsp_fifo:in_data
	...
	wire  [107:0] switch_s1_agent_rsp_fifo_out_data;                                                  // switch_s1_agent_rsp_fifo:out_data -> switch_s1_agent:rf_sink_data
	...
	wire  [106:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> switch_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                              // switch_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [8:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> switch_s1_agent:cp_channel
	...
	wire   [28:0] key2_s1_agent_m0_address;                                                           // key2_s1_agent:m0_address -> key2_s1_translator:uav_address
	...
	wire  [107:0] key2_s1_agent_rf_source_data;                                                       // key2_s1_agent:rf_source_data -> key2_s1_agent_rsp_fifo:in_data
	...
	wire  [107:0] key2_s1_agent_rsp_fifo_out_data;                                                    // key2_s1_agent_rsp_fifo:out_data -> key2_s1_agent:rf_sink_data
	...
	wire          cmd_mux_007_src_valid;                                                              // cmd_mux_007:src_valid -> key2_s1_agent:cp_valid
	wire  [106:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> key2_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                              // key2_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [8:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> key2_s1_agent:cp_channel
	wire          cmd_mux_007_src_startofpacket;                                                      // cmd_mux_007:src_startofpacket -> key2_s1_agent:cp_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                                        // cmd_mux_007:src_endofpacket -> key2_s1_agent:cp_endofpacket
	...
	wire   [28:0] key3_s1_agent_m0_address;                                                           // key3_s1_agent:m0_address -> key3_s1_translator:uav_address
	...
	wire  [107:0] key3_s1_agent_rf_source_data;                                                       // key3_s1_agent:rf_source_data -> key3_s1_agent_rsp_fifo:in_data
	...
	wire  [107:0] key3_s1_agent_rsp_fifo_out_data;                                                    // key3_s1_agent_rsp_fifo:out_data -> key3_s1_agent:rf_sink_data
	...
	wire          cmd_mux_008_src_valid;                                                              // cmd_mux_008:src_valid -> key3_s1_agent:cp_valid
	wire  [106:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> key3_s1_agent:cp_data
	wire          cmd_mux_008_src_ready;                                                              // key3_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire    [8:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> key3_s1_agent:cp_channel
	wire          cmd_mux_008_src_startofpacket;                                                      // cmd_mux_008:src_startofpacket -> key3_s1_agent:cp_startofpacket
	wire          cmd_mux_008_src_endofpacket;                                                        // cmd_mux_008:src_endofpacket -> key3_s1_agent:cp_endofpacket
	...
	wire  [106:0] switch_s1_agent_rp_data;                                                            // switch_s1_agent:rp_data -> router_008:sink_data
	...
	wire          key2_s1_agent_rp_valid;                                                             // key2_s1_agent:rp_valid -> router_009:sink_valid
	wire  [106:0] key2_s1_agent_rp_data;                                                              // key2_s1_agent:rp_data -> router_009:sink_data
	wire          key2_s1_agent_rp_ready;                                                             // router_009:sink_ready -> key2_s1_agent:rp_ready
	wire          key2_s1_agent_rp_startofpacket;                                                     // key2_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          key2_s1_agent_rp_endofpacket;                                                       // key2_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire          key3_s1_agent_rp_valid;                                                             // key3_s1_agent:rp_valid -> router_010:sink_valid
	wire  [106:0] key3_s1_agent_rp_data;                                                              // key3_s1_agent:rp_data -> router_010:sink_data
	wire          key3_s1_agent_rp_ready;                                                             // router_010:sink_ready -> key3_s1_agent:rp_ready
	wire          key3_s1_agent_rp_startofpacket;                                                     // key3_s1_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire          key3_s1_agent_rp_endofpacket;                                                       // key3_s1_agent:rp_endofpacket -> router_010:sink_endofpacket
	...
	wire          key2_s1_agent_rdata_fifo_src_valid;                                                 // key2_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] key2_s1_agent_rdata_fifo_src_data;                                                  // key2_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire          key2_s1_agent_rdata_fifo_src_ready;                                                 // avalon_st_adapter_007:in_0_ready -> key2_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_007_out_0_valid;                                                  // avalon_st_adapter_007:out_0_valid -> key2_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_007_out_0_data;                                                   // avalon_st_adapter_007:out_0_data -> key2_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_007_out_0_ready;                                                  // key2_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire    [0:0] avalon_st_adapter_007_out_0_error;                                                  // avalon_st_adapter_007:out_0_error -> key2_s1_agent:rdata_fifo_sink_error
	wire          key3_s1_agent_rdata_fifo_src_valid;                                                 // key3_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_008:in_0_valid
	wire   [33:0] key3_s1_agent_rdata_fifo_src_data;                                                  // key3_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_008:in_0_data
	wire          key3_s1_agent_rdata_fifo_src_ready;                                                 // avalon_st_adapter_008:in_0_ready -> key3_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_008_out_0_valid;                                                  // avalon_st_adapter_008:out_0_valid -> key3_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_008_out_0_data;                                                   // avalon_st_adapter_008:out_0_data -> key3_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_008_out_0_ready;                                                  // key3_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_008:out_0_ready
	wire    [0:0] avalon_st_adapter_008_out_0_error;                                                  // avalon_st_adapter_008:out_0_error -> key3_s1_agent:rdata_fifo_sink_error
